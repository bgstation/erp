...
class AclTipoUsuarioController extends Controller {
    ...
    public function actionCreate() {
        ...
        $this->render('create', array(
            'model' => $model,
            'aAclRotas' => $oAclRota->getAclRotasArray(),
        ));
    }
    ...
    public function actionUpdate($id) {
        ...
        $this->render('update', array(
            'model' => $model,
            'aAclRotas' => $oAclRota->getAclRotasArray(),
            'aAclTipoUsuarioRotas' => $oAclTipoUsuarioRota->retornaRotasPorTipoUsuario(),
        ));
    }
    ...
    public function actionIndex() {
        $dataProvider = new CActiveDataProvider('AclTipoUsuario');
     ...
     * @return AclTipoUsuario the loaded model
     * @throws CHttpException
     */
    public function loadModel($id) {
        $model = AclTipoUsuario::model()->findByPk($id);
        if ($model === null)
     ...
     * @param AclTipoUsuario $model the model to be validated
     */
    protected function performAjaxValidation($model) {
        if (isset($_POST['ajax']) && $_POST['ajax'] === 'acl-tipo-usuario-form') {
