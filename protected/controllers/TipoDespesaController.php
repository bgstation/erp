...
class TipoDespesaController extends Controller
{
	...
	public function actionCreate()
	{
		...
		if(isset($_POST['TipoDespesa']))
		{
			$model->attributes=$_POST['TipoDespesa'];
			if($model->save())
	...
	{
		$dataProvider=new CActiveDataProvider('TipoDespesa');
	 ...
	 * @param TipoDespesa $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='tipo-despesa-form')
		{
