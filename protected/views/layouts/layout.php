...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="en" lang="en">
    <head>
        ...
        <link href="<?= Yii::app()->request->baseUrl ?>/dist/css/timeline.css" rel="stylesheet" />
        <link href="<?= Yii::app()->request->baseUrl ?>/dist/css/sb-admin-2.css" rel="stylesheet" />
        <link href="<?= Yii::app()->request->baseUrl ?>/bower_components/morrisjs/morris.css" rel="stylesheet" />
    ...
    <body>
        <div id="wrapper">
            ...
            <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
                <div class="navbar-header">
                    ...
                    <a class="navbar-brand" href="<?= Yii::app()->createUrl(Yii::app()->defaultController) ?>">
                ...
                <div class="navbar-default sidebar" role="navigation">
                    <div class="sidebar-nav navbar-collapse">
                        <ul class="nav" id="side-menu">
                            <li>
                                <a href="<?= Yii::app()->createUrl(Yii::app()->defaultController) ?>">
        ...
        <script src="<?= Yii::app()->request->baseUrl ?>/bower_components/raphael/raphael-min.js"></script>
        <!--<script src="<?= Yii::app()->request->baseUrl ?>/bower_components/morrisjs/morris.min.js"></script>-->
        <!--<script src="<?= Yii::app()->request->baseUrl ?>/js/morris-data.js"></script>-->
        <script src="<?= Yii::app()->request->baseUrl ?>/dist/js/sb-admin-2.js"></script>
    </body>
</html>
